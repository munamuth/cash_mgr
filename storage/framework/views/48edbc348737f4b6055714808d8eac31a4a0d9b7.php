	...
	<div class="container-fluid">
		...
		<div class="row" id="second-row">
			<div class="col-12 col-sm-12 col-md-5 col-lg-4 col-xl-3 bg-success p-0 d-none d-md-block" id="menu">
				<ul class="menu">
					<li><a href="<?php echo e(url('/')); ?>">Home <span class="float-right"><i class="fa fa-angle-down"></i></span></a></li>
					<li><a href="<?php echo e(url('/income')); ?>">Income <span class="float-right"><i class="fa fa-angle-down"></i></span></a></li>
					<li><a href="<?php echo e(url('/expense')); ?>">Expense <span class="float-right"><i class="fa fa-angle-down"></i></span></a></li>
					<li><a href="<?php echo e(url('/type')); ?>">Types <span class="float-right"><i class="fa fa-angle-down"></i></span></a></li>
					<li><a href="<?php echo e(url('/users')); ?>">Users <span class="float-right"><i class="fa fa-angle-down"></i></span></a></li>
					<li><a href="<?php echo e(route('logout')); ?>" onclick="event.preventDefault(); document.getElementById('logout-form').submit();" class="text-light">Logout</a></li>
