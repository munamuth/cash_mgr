...
<?php $__env->startSection('body'); ?>
	<div class="row">
		<div class="col">
			...
			<form action="<?php echo e(route('expense.update', [$local, $expense->id])); ?>" method="post" enctype="multipart/form-data" autocomplete="off">
				<?php echo csrf_field(); ?>
							...
							<div class="card-body">
								<div class="form-group row">
									...
									<div class="col-12 col-sm-6">
										<input class="form-control form-control-sm datepicker" type="text" name="create" value="<?php echo e(($expense->created_at)->format('d/m/Y')); ?>">
									</div>
								</div>
								<div class="form-group row">
