	...
	<div class="row animated fadeIn">
		<div class="col-12 col-sm-10 col-md-8 col-lg-6 col-xl-4 m-auto">
			<div class="card animated zoomIn">
				...
				<form action="<?php echo e(route('type.update', [$local, $type->id])); ?>" method="post" enctype="multipart/form-data">
					<?php echo csrf_field(); ?>
						...
						<div class="row form-group">
							<div class="col-12 col-sm-12">
								<div class="text-right">
									<button type="submit" class="btn btn-success btn-sm"><i class="fa fa-download"></i> <?php echo e(trans('lang.update')); ?></button>
								</div>
							</div>
						</div>
